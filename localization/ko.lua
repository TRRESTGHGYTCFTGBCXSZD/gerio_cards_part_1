...
table.insert(baseball_locale.text, "{C:inactive}(Rigged의 트리거 확률보다 높음){}")
end
if SMODS.Mods["SnowHolidayJokers"] then
table.insert(baseball_locale.text, "{C:inactive}(AAAH?! It's Infinity!?의 트리거 확률보다 높음){}")
end
...
return {
	descriptions = {
		...
		Other = {
			...
			gerio_baseball = baseball_locale,
		},
	},
	misc={
		dictionary={
